...
public class DefaultCheckboxTreeCellRenderer extends JPanel implements CheckboxTreeCellRenderer {
    ...
    public DefaultCheckboxTreeCellRenderer(String type) {
	...
	if(type == "treeLayer"){		
		this.label = new DefaultTreeCellRenderer(){
		      public Component getTreeCellRendererComponent(final JTree tree,Object value,
		  	      ...
		  	      if(((DefaultMutableTreeNode)value).isRoot()) label.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().
		  	  			getImage(OpsimGUI.class.getResource("/cm/opsim/view/img/layer.png"))));
		  	      //else label.set
		  	      return label;
		  	    }
		  	  };
		this.label.setOpenIcon(new ImageIcon(Toolkit.getDefaultToolkit().
		  			getImage(OpsimGUI.class.getResource("/cm/opsim/view/img/display.png"))));
		this.label.setClosedIcon(new ImageIcon(Toolkit.getDefaultToolkit().
	  			getImage(OpsimGUI.class.getResource("/cm/opsim/view/img/display.png"))));
	}
