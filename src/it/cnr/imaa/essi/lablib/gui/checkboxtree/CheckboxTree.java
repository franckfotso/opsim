...
public class CheckboxTree extends JTree {
     ...
     */
    public CheckboxTree(TreeModel treemodel, String type) {
	super(treemodel);
	this.type = type;
	initialize();
    }
	...
	setCellRenderer(new DefaultCheckboxTreeCellRenderer(this.type));
	...
	if (!(tcl instanceof CheckboxTreeCellRenderer) && !(tcl instanceof DefaultTreeCellRenderer)) {
	...
	if (cellRenderer == null) {
	    cellRenderer = new DefaultCheckboxTreeCellRenderer(this.type);
	}
